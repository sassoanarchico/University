...
Quindi, la risposta corretta è 'a. Ws=3'."""
    ...
    {
        "esame": "Febbraio d8",
        "testo_domanda": "In una rete CDMA/CD la massima distanza tra due stazioni è di 2000 m. Qual è lil minimo tempo di tramissione di una trama se la velocità di propagazione sul mezzo è di 4 * 1014 m/sec?",
        "immagine_domanda": None,
        "opzioni": [
            {"testo": "a. 0,1s"},
            {"testo": "b. 2s"},
