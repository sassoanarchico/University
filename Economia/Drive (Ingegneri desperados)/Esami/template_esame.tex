...
\begin{figure}[h] % Inizia un ambiente figura
\includegraphics[width=0.9\textwidth]{tab.png} % Specifica il nome del file e la larghezza della figura
\label{fig:esempio} % Etichetta la figura per riferimenti incrociati
\end{figure} % Fine ambiente figura
