...
// 1. Rimuovi e memorizza in una variabile node il riferimento al primo elemento della lista e aggiorna di conseguenza list->head
// 2. Inverti la parte restante della lista
// 3. Fai puntare l'ultimo elemento a node e aggiorna tail a node
