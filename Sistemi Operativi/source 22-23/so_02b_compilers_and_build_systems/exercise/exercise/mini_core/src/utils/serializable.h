...
#define BOSS_REGISTER_CLASS(class_name)                                 \
  static mini_core::AutoRegisterer<class_name > _reg_##class_name(#class_name,typeid(class_name).name());

#define BOSS_REGISTER_CLASS_WITH_NAME(class_name, type_name)            \
  static mini_core::AutoRegisterer<class_name > _reg_##class_name(#type_name,typeid(class_name).name()));
