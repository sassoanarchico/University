...
namespace mini_core {
  ...
  */
  ...
  public:
    ...
    using ThisType       = Matrix_<CellType, AllocatorType, Traits>;
    ...
    ThisType& operator=(const Matrix_& other);

    void copyRegionTo(ThisType& dest,
    ...
    inline Eigen::Vector2i pos(const CellType* c) const {
